...
class PageRankCrawlerTests(unittest.TestCase):
    ...
    def test_search_word_two(self):
        ...
        self.assertEqual(isValid, True, "Search word 'contributions' does not match expected output");
    ...
    def __get_result_set(self, num):
        ...
        resultSetTwo = {0: {'description': u" 5,505,963 articles in English Arts Biography Geography History Mathematics Science Society Technology All portals From today's featured article Wheeled toy animal Rotating locomotion in living...",
                             'title': u'Wikipedia, the free encyclopedia',
